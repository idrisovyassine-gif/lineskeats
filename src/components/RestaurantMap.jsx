...
function LocationMarker({ onLocationFound, onLocationError, autoLocate = false }) {
  ...
  return (
    <>
      ...
      {position ? <Marker position={position} title="Votre position" /> : null}
    </>
  )
}
...
function FitBounds({ heroMode, isFullscreen, restaurants }) {
  ...
  useEffect(() => {
    ...
    const padding = {
      top: isMobileViewport ? (isFullscreen ? 96 : heroMode ? 152 : 72) : heroMode ? 164 : 56,
      right: isMobileViewport ? 28 : 72,
      bottom: isMobileViewport ? (isFullscreen ? 190 : heroMode ? 84 : 128) : isFullscreen ? 112 : heroMode ? 168 : 72,
